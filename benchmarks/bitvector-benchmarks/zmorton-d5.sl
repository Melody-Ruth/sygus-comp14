; Synthesize the matrix indexing function for the ZMORTON layout.
...
(constraint (= (zmorton_spec i j) (zmorton_impl i j)))
(check-synth)    
        
; Solution:  same body for zmorton_impl as for zmorton_spec 