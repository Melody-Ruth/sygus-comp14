...
/*
  audupa: Adapted this file from Bob Jenkins' Spooky hash.
  All credits for the hash function go to Bob Jenkins.
  Any errors are (most likely) due to my adaptation.
*/

#if !defined __SPOOKY_HASH_SPOOKY_HASH_HPP
#define __SPOOKY_HASH_SPOOKY_HASH_HPP
